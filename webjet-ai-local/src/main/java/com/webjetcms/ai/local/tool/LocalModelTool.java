...
public final class LocalModelTool {
    ...
    private static String help(List<LocalModelRecipe> recipes) {
        ...
        return ("webjet-ai-local-model-tool\n\nPrepare a verified local-model ZIP without loading or executing the model.\n\n"
            + "Usage:\n  java -jar webjet-ai-local-VERSION.jar prepare --model MODEL [options]\n"
            + "  java -jar webjet-ai-local-VERSION.jar --help\n  java -jar webjet-ai-local-VERSION.jar --version\n\n"
            + "Source checkout:\n  ./gradlew :webjet-ai-local:localModelTool --args='prepare --model MODEL [options]'\n\n"
            + "Required:\n  --model MODEL       %s\n\nOptions:\n"
